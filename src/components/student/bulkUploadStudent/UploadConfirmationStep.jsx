			...
			{uploadResult ? (
				...
				>
					...
					<Box sx={{ mb: 2 }}>
						...
						<Typography variant="body2">{totalUploadCount} students will be uploaded</Typography>
					</Box>
