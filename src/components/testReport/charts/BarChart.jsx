...
const BarChart = ({ 
  ...
  return (
    <div className={`bar-chart-container relative ${className}`} style={{ 
      height: `${height}px`, 
      width: '100%',
          ...
          return (
            ...
            >
              ...
              {showValues && hoveredIndex === index && (
                <div className="absolute z-10 px-2 py-1 text-xs font-medium text-white bg-gray-800 rounded shadow"
                     style={{
