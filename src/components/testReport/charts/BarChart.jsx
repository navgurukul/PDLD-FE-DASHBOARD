...
const BarChart = ({
  ...
  return (
    ...
    >
      ...
      {/* Y-axis values */}
      <div className="absolute top-0 left-0 bottom-8 flex flex-col justify-between text-xs text-gray-500 pl-1">
        {[4, 3, 2, 1, 0].map((i) => {
      ...
      <div className="absolute left-12 right-4 bottom-8 top-0 flex items-end justify-between">
        {data.map((item, index) => {
