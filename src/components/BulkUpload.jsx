	...
	return (
		<ThemeProvider theme={theme}>
			<Box sx={{ p: 2, px: 2, maxWidth: "75rem", margin: "0 auto" }}>
						...
						{uploadResult ? (
							...
							>
								...
								<Box sx={{ mb: 2 }}>
									...
									<Typography variant="body2">{totalUploadCount} schools will be uploaded</Typography>
								</Box>
				...
				{/* Sample CSV Modal */}
				<SampleCSVModal open={sampleModalOpen} onClose={() => setSampleModalOpen(false)} entityType="school" />
