    ...
    MuiTableCell: {
      styleOverrides: {
        ...
        head: {
          ...
          fontSize: "14px",
          color: "#2F4F4F",
          textTransform: "none !important", // Remove uppercase
        },
      },
    },
    MuiTableRow: {
      styleOverrides: {
        root: {
          "&:hover": {
            backgroundColor: "inherit !important", // Remove row hover background
            cursor: "default",
          },
        },
      },
...
export default function EnrollmentReport() {
  ...
  // Custom header renderer to match TestListTable.jsx
