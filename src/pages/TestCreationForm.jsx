...
import BatchTestCreation from "../components/BatchTestCreation"
    ...
    <>
      <div style={{ width: "40%", margin: "20px auto" }}>
        <div className="space-y-4 mt-12">
          <BatchTestCreation />
          <h2 className="text-xl font-semibold mb-2 text-[#2F4F4F]">Test Type</h2>
          <div className="flex space-x-4">
            <label className="flex items-center space-x-2">
              ...
              />
              <span
                className={`px-2 py-2 rounded-lg ${testType === "regular" ? "text-gray-700 font-bold" : "text-gray-700"}`}
              >
                Syllabus
              </span>
            </label>
            ...
            <label className="flex items-center space-x-2">
              ...
              />
              <span
                className={`px-2 py-2 rounded-lg ${testType === "remedial" ? "text-gray-700 font-bold" : "text-gray-700"}`}
              >
                Remedial
              </span>
            </label>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold mb-2 text-[#2F4F4F]">Classes</h2>
        ...
        <div className="flex justify-center px-4 py-3">
          <button
            ...
            className={`flex justify-center h-11 px-4 py-2 w-[120px] ${!isFormValid()
