...
export const MOCK_TESTS = [
	{
	  ...
	  schools: [
		{ 
		  ...
		  students: [
			{ id: 1, name: "Arun Sharma", score: 88 }, 
			{ id: 2, name: "Divya Kapoor", score: 92 },
			{ id: 3, name: "Farhan Ahmed", score: 65 }, 
			{ id: 4, name: "Geeta Nair", score: 78 },
			{ id: 5, name: "Hari Kumar", score: 35 }, 
			{ id: 6, name: "Isha Verma", score: 85 }
		  ]
		},
		{ 
		  id: 2, 
